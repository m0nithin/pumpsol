    ...
    [769], {
        74769: function(e, r, o) {
            ...
            function i() {
                let e, r, o = 0,
                    t = "";
                for (; o < arguments.length;)(e = arguments[o++]) && (r = function e(r) {
                    let o;
                    if ("string" == typeof r) return r;
                    let t = "";
                    for (let n = 0; n < r.length; n++) r[n] && (o = e(r[n])) && (t && (t += " "), t += o);
                    return t
                }(e)) && (t && (t += " "), t += r);
                return t
            }
            ...
            let T = function(e) {
                ...
                let a = function(l) {
                    ...
                    return o = (r = {
                        ...
                        ... function(e) {
                            let r = function(e) {
                                    ...
                                    return (r = Object.entries(e.classGroups), t ? r.map(([e, r]) => [e, r.map(e => "string" == typeof e ? t + e : "object" == typeof e ? Object.fromEntries(Object.entries(e).map(([e, r]) => [t + e, r])) : e)]) : r).forEach(([e, r]) => {
                                        (function e(r, o, t, l) {
                                            r.forEach(r => {
                                                if ("string" == typeof r) {
                    ...
                    }).cache.get, s = r.cache.set, a = c, c(l)
                };
                ...
                function c(e) {
                    ...
                    let n = function(e, r) {
                        ...
                        return e.trim().split(l).map(e => {
                            ...
                            } = o(e), s = t(i ? l.substring(0, i) : l), a = !!i;
                            if (!s) {
                                if (!i || !(s = t(l))) return {
                                    isTailwindClass: !1,
                                    originalClassName: e
                            ...
                            return !i.has(l) && (i.add(l), n(o, t).forEach(e => i.add(r + e)), !0)
                ...
                let e = s("colors"),
                    ...
                    L = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity", "plus-lighter"],
                ...
                return {
                    ...
                    theme: {
                        ...
                        gradientColorStopPositions: [y, g],
                        inset: B(),
                        margin: B(),
                        opacity: X(),
                        padding: D(),
                    ...
                    classGroups: {
                        ...
                        leading: [{
                            leading: ["none", "tight", "snug", "normal", "relaxed", "loose", m, v]
                        }],
                        "list-image": [{
                            "list-image": ["none", v]
                        }],
